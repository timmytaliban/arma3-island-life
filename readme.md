...
- Corruption in any form is not tolerated. This includes accepting bribes, selling/trading police equipment with other players, etc.
- Police players may only use equipment from police shops.
- Police players must use all in-game systems alloted to them for enforcing the law.
- Police shall follow all laws, exceptions only when it interferes with their duties.
- Police require probable cause or reasonable suspicion to pull over players.
- Police may only use lethal force when another player's life is reasonably in danger, or as a calculated risk when traditional means of intervention/restraining fail.
...
- EMS players may not sell any of their equipment to civilians or police.
- EMS players may not revive any players as long as there is active combat. In the case of active combat, they may stand on the sidelines until the perpetrators flee or the Police control the situation.
- EMS follows this revive order/job priority. EMS -> Police -> Civilians
- EMS must remain impartial to all factions.

# Civilian
- All civilian players are encouraged to join the Discord in order to stay up to date with the latest news and events.
- EMS/FD players may not be robbed, harassed, etc. barring certain exceptions.
