...
compileFinal "
    ...
    switch (_type) do {
        case 0 : {
            if ((missionNamespace getVariable [""life_inv_cellphone"",0]) < 1 && {(call life_adminlevel) < 1}) exitWith {};
            private [""_message""];
        ...
        case 1 : {
            ...
            if (!(""ItemRadio"" in assignedItems player) && {(call life_adminlevel) < 1}) exitWith {};
